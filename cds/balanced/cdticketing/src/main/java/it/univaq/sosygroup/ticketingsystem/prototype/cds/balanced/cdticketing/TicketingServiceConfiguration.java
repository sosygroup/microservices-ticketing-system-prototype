...
public class TicketingServiceConfiguration {
    ...
    ServiceInstanceListSupplier serviceInstanceListSupplier() {
        return new TicketingServiceInstanceListSuppler("ticketing");
    }
}

class TicketingServiceInstanceListSuppler implements ServiceInstanceListSupplier {

    private final String serviceId;

    TicketingServiceInstanceListSuppler(String serviceId) {
